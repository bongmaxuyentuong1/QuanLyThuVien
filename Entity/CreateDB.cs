...
{
    public class CreateDB : DropCreateDatabaseIfModelChanges<QuanLyThuVienEntities>
    {
        protected override void Seed(QuanLyThuVienEntities context)
        {
            ...
            {
                new SACH {MASACH = "001", NHANDE = "Truyen Kieu", MATHELOAI = "001", MANXB = "001", NAMXB = DateTime.Now.Date, MANGONNGU = "001", TACGIA = "Nguyen Du", TONGSL = 98, SLDANGMUON = 8, SLHIENTAI = 90, SLTONKHO = 2},
                new SACH {MASACH = "002", NHANDE = "Lap trinh C", MATHELOAI = "002", MANXB = "002", NAMXB = DateTime.Now.Date, MANGONNGU = "001",TACGIA = "Khanh Duong",TONGSL = 90, SLDANGMUON = 0, SLHIENTAI = 90, SLTONKHO = 10},
                new SACH {MASACH = "003", NHANDE = "Deep Learning", MATHELOAI = "002", MANXB = "001", NAMXB = DateTime.Now.Date, MANGONNGU = "002", TACGIA = "Yoshua Bengio", TONGSL = 90, SLDANGMUON = 0, SLHIENTAI = 90, SLTONKHO = 100},
                new SACH {MASACH = "004", NHANDE = "Lieu IT Da Het Thoi", MATHELOAI = "001", MANXB = "002", NAMXB = DateTime.Now.Date, MANGONNGU = "002", TACGIA = "N.G.Carr", TONGSL = 98, SLDANGMUON = 8, SLHIENTAI = 90, SLTONKHO = 2 },
                new SACH {MASACH = "005", NHANDE = "Code dao ky su", MATHELOAI = "002", MANXB = "003", NAMXB = DateTime.Now.Date, MANGONNGU = "001", TACGIA = "Pham Huy Hoang", TONGSL = 98, SLDANGMUON = 8, SLHIENTAI = 90, SLTONKHO = 2 },
                new SACH {MASACH = "006", NHANDE = "The Pragmatic Programmer", MATHELOAI = "001", MANXB = "004", NAMXB = DateTime.Now.Date, MANGONNGU = "002", TACGIA = "Andrew Hunt", TONGSL = 97, SLDANGMUON = 7, SLHIENTAI = 90, SLTONKHO = 3 },
                new SACH {MASACH = "007", NHANDE = "The Design of Everyday Things", MATHELOAI = "004", MANXB = "005", NAMXB = DateTime.Now.Date, MANGONNGU = "002", TACGIA = "Donald A. Norman", TONGSL = 96, SLDANGMUON = 6, SLHIENTAI = 90, SLTONKHO = 4 },
                new SACH {MASACH = "008", NHANDE = "Gian diep mang", MATHELOAI = "004", MANXB = "006", NAMXB = DateTime.Now.Date, MANGONNGU = "001", TACGIA = "Clifford Stoll", TONGSL = 95, SLDANGMUON = 5, SLHIENTAI = 90, SLTONKHO = 5 },
                new SACH {MASACH = "009", NHANDE = "Nghe thuat an minh", MATHELOAI = "004", MANXB = "006", NAMXB = DateTime.Now.Date, MANGONNGU = "001", TACGIA = "Kevin Mitnick", TONGSL = 94, SLDANGMUON = 4, SLHIENTAI = 90, SLTONKHO = 6 },
                new SACH {MASACH = "010", NHANDE = "Lap trinh va cuoc song", MATHELOAI = "004", MANXB = "003", NAMXB = DateTime.Now.Date, MANGONNGU = "001", TACGIA = "Jeff Atwood", TONGSL = 91, SLDANGMUON = 1, SLHIENTAI = 90, SLTONKHO = 9 },
            });
            // SINHVIEN
            ...
            {
                new NGUOIDUNG {MANGUOIDUNG = "001", MANHIEMVU = "001", TAIKHOAN = "thuthu1", MATKHAU = "1", HOTEN = "Le Thi Tram", NAMSINH = DateTime.Now.Date, GIOITINH = false, DIENTHOAI = "0202020202", EMAIL = "tramlt@gmail.com"},
                new NGUOIDUNG {MANGUOIDUNG = "002", MANHIEMVU = "002", TAIKHOAN = "thukho1", MATKHAU = "1", HOTEN = "Nguyen Thi Huyen", NAMSINH = DateTime.Now.Date, GIOITINH = false, DIENTHOAI = "0303030303", EMAIL = "huyennt@gmail.com"},
            });
            // NHAPSACH
            ...
            {
                new PHIEUMUON {MAPHIEU = "001", MADOCGIA = "001", MANGUOIDUNG = "001", NGAYMUON = DateTime.Now.Date, NGAYTRA = new DateTime(2022,7,30)},
                new PHIEUMUON {MAPHIEU = "002", MADOCGIA = "002", MANGUOIDUNG = "001", NGAYMUON = DateTime.Now.Date, NGAYTRA = new DateTime(2022,7,20)},
                new PHIEUMUON {MAPHIEU = "003", MADOCGIA = "003", MANGUOIDUNG = "001", NGAYMUON = DateTime.Now.Date, NGAYTRA = new DateTime(2022,7,10)},
                new PHIEUMUON {MAPHIEU = "004", MADOCGIA = "004", MANGUOIDUNG = "001", NGAYMUON = DateTime.Now.Date, NGAYTRA = new DateTime(2022,7,15)},
                new PHIEUMUON {MAPHIEU = "005", MADOCGIA = "005", MANGUOIDUNG = "001", NGAYMUON = DateTime.Now.Date, NGAYTRA = new DateTime(2022,7,29)},
                new PHIEUMUON {MAPHIEU = "006", MADOCGIA = "006", MANGUOIDUNG = "001", NGAYMUON = DateTime.Now.Date, NGAYTRA = new DateTime(2022,7,6)},
                new PHIEUMUON {MAPHIEU = "007", MADOCGIA = "007", MANGUOIDUNG = "001", NGAYMUON = DateTime.Now.Date, NGAYTRA = new DateTime(2022,7,8)},
            });
            // BANGIAO
            context.BANGIAOs.AddRange(new BANGIAO[]
            {
                new BANGIAO {MABANGIAO = "001", MANGUOIBANGIAO = "001", MANGUOIXACNHAN = "002", NGAYBANGIAO = DateTime.Now, NGAYXACNHAN = DateTime.Now.AddSeconds(90)},
                new BANGIAO {MABANGIAO = "002", MANGUOIBANGIAO = "001", MANGUOIXACNHAN = "002", NGAYBANGIAO = DateTime.Now, NGAYXACNHAN = DateTime.Now.AddSeconds(60)},
                new BANGIAO {MABANGIAO = "003", MANGUOIBANGIAO = "001", MANGUOIXACNHAN = "002", NGAYBANGIAO = DateTime.Now, NGAYXACNHAN = DateTime.Now.AddSeconds(150)},
            });
            // CHITIETBANGIAO
