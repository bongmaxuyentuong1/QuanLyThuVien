...
namespace QuanLyThuVien.VIEW
{
    public partial class Form_Thuthu : Form
    {
        ...
        public Form_Thuthu(string admin, string nhiemvu)
        {
            InitializeComponent();
            customizeDesing();
            user = admin;
        ...
        #region QLNSMenu
        private void btnQLNS3_Click(object sender, EventArgs e)
        {
            showSubMenu(pnQLNS);
        }

        private void btnQLNS1_Click(object sender, EventArgs e)
        {

        }

        private void btnQLNS2_Click(object sender, EventArgs e)
        {
        ...
        #region MenuBanGiao
        private void yêuCầuToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            Bangiao_Danhsach f = new Bangiao_Danhsach(manguoidung);
            openChildForm(f);
        }

        private void tạoMớiBànGiaoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Bangiao_Them f = new Bangiao_Them(this.manguoidung);
            openChildForm(f);
        }

        private void tìmKiếmBànGiaoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Bangiao_Tim f = new Bangiao_Tim(this.manguoidung);
            openChildForm(f);
        }
        ...
        private void danhSáchNhậpSáchToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Nhapsach_Danhsach f = new Nhapsach_Danhsach(this.manguoidung);
            openChildForm(f);
        }

        private void nhậpSáchToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            Nhapsach_Them f = new Nhapsach_Them(this.manguoidung);
            openChildForm(f);
        }

        private void tìmPhiếuNhậpSáchToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Nhapsach_Tim f = new Nhapsach_Tim();
            openChildForm(f);
        }
